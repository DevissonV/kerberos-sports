...
| LaLiga | KSS-V1-C03-ESP | football-data.co.uk | OBSERVATION_ONLY |
| Serie A | KSS-V1-C04-ITA | football-data.co.uk | OBSERVATION_ONLY |
| Bundesliga | KSS-V1-C05-GER | football-data.co.uk | OBSERVATION_ONLY |
| Ligue 1 | KSS-V1-C06-FRA | football-data.co.uk | OBSERVATION_ONLY |
| Eredivisie | KSS-V1-C07-NED | football-data.co.uk | OBSERVATION_ONLY |
...
- No se promovieron Colombia ni las ligas europeas: faltan aliases completos
  contra API-Football/OddsPapi y smoke real de Poisson. En Colombia también falta
  histórico reproducible 2024--2026.
